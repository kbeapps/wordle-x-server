...
const create = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'create game', undefined, validationError);
    return;
  }
...
const get = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'get game', undefined, validationError);
    return;
  }
...
const getAll = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'get all games', undefined, validationError);
    return;
  }
...
const update = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'update game', undefined, validationError);
    return;
  }
...
const remove = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'remove game', undefined, validationError);
    return;
  }
