...
const create = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'create', undefined, validationError);
    return;
  }
...
const getAll = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'getAll', undefined, validationError);
    return;
  }
...
const removeAll = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'removeAll', undefined, validationError);
    return;
  }
