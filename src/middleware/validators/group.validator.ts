...
const create = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'create group', undefined, validationError);
    return;
  }
...
const get = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'get group', undefined, validationError);
    return;
  }
...
const getAll = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'get all groups', undefined, validationError);
    return;
  }
...
const update = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'update group', undefined, validationError);
    return;
  }
...
const remove = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (validationError) {
    responseHandler(res, 400, 'remove group', undefined, validationError);
    return;
  }
